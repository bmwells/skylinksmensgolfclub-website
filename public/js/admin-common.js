// admin-common.js - Main loader for admin utilities
...
function loadModulesSequentially(index) {
    if (index >= ADMIN_MODULES.length) {
        // All modules loaded, initialize common functionality
        initializeCommon();
        return;
    }
...
function initializeCommon() {
    console.log('All admin modules loaded, initializing...');
...
// Start loading modules when this script is loaded
// But wait a bit to ensure DOM is available
